...
public class ChannelFactory {
        ...
        public static ChannelId buildChannel(String channelDifferentiator, YoutubeClient client) throws IOException, InterruptedException {
        ...
        private static ChannelId createChannelFromId(String channelId) {
                return new ChannelId(channelId);
        }

        private static ChannelId createChannelFromUsername(String username, YoutubeClient client) throws IOException, InterruptedException {
